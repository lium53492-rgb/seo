  ...
  return (
    <main className={styles.shell}>
      <nav className={styles.nav} aria-label="Primary navigation">
        <span className={styles.brand}><span>P</span>PLAYWORLDS ROUTE MAP</span>
        <TrackedPlayworldsLink sourceSlug={page.slug} location="header">VIEW PLAYWORLDS ↗</TrackedPlayworldsLink>
      </nav>
      ...
      <footer className={styles.destinationCta}><span>DESTINATION</span><h2>The route ends inside the story.</h2><TrackedPlayworldsLink sourceSlug={page.slug} location="final_cta">View Playworlds on Steam ↗</TrackedPlayworldsLink></footer>
    </main>
  );
}
